...
/**
 * @author weifujun 860. 柠檬水找零
 * @version Created in 2021年2月24日 下午11:30:27
 */
public class LemonadeChange {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		int array[] = { 5, 10, 20, 5, 10 };
		boolean res = lemonadeChange(array);
		System.out.println(res);

		int array2[] = { 5, 5, 10, 5, 10 };
		boolean res2 = lemonadeChange(array2);
